...
In this project, we use the Open FLight dataset with the algoritms and traversals in order to deeply explore the applications of data structure and better understand the development of aviation and human geography. Based on the given data, our project aims to find the most convnient path by using BFS and Dijkstra's algorithm, and find the most important airport by using PageRank.
